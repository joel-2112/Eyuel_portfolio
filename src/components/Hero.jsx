    ...
    <section className="relative w-full h-screen mx-auto">
      ...
      <div className={`absolute inset-0 top-[120px] max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}>
        <div className="flex flex-col justify-center items-center mt-5">
          ...
          <div className="w-1 sm:h-80 h-40 bg-gradient-to-b from-blue-500 to-gray-100" />
        </div>

        <div>
          <h1 className={`${styles.heroHeadText}`}>
            Hi, I'm <span className="text-blue-600">Eyuel</span>
          </h1>
      ...
      <div className="absolute xs:bottom-10 bottom-32 w-full flex justify-center items-center">
        <motion.div
          className="w-[35px] h-[64px] rounded-3xl border-4 border-blue-500 flex justify-center items-start p-2 cursor-pointer"
